...
import com.opennetwork.secureim.server.controllers.NoSuchUserException;
...
import com.opennetwork.secureim.server.entities.CryptoEncodingException;
import com.opennetwork.secureim.server.entities.EncryptedOutgoingMessage;
...
public class WebSocketConnection implements DispatchChannel {
  ...
  public void onDispatchMessage(String channel, byte[] message) {
    try {
      PubSubProtos.PubSubMessage pubSubMessage = PubSubProtos.PubSubMessage.parseFrom(message);

      switch (pubSubMessage.getType().getNumber()) {
        case PubSubProtos.PubSubMessage.Type.QUERY_DB_VALUE:
        ...
        case PubSubProtos.PubSubMessage.Type.DELIVER_VALUE:
          ...
          break;
        case PubSubProtos.PubSubMessage.Type.CONNECTED_VALUE:
