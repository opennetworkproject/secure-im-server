...
import com.opennetwork.secureim.server.websocket.WebSocketConnectionInfo;
...
public class ApnFallbackManager implements Managed, Runnable, DispatchChannel {
  ...
  public void onDispatchMessage(String channel, byte[] message) {
    try {
      PubSubProtos.PubSubMessage notification = PubSubProtos.PubSubMessage.parseFrom(message);

      if (notification.getType().getNumber() == PubSubProtos.PubSubMessage.Type.CONNECTED_VALUE) {
